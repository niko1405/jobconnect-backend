...
![Version: 2025.10.1](https://img.shields.io/badge/Version-2025.10.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2025.10.1-buildpacks-bellsoft](https://img.shields.io/badge/AppVersion-2025.10.1--buildpacks--bellsoft-informational?style=flat-square)

Helm Chart für jobconnect
...
| deployment.containerPortHttp | int | `8080` |  |
| deployment.containerPortHttps | int | `8443` | Port innerhalb des Containers |
...
| image.name | string | `"jobconnect"` | Name des Image |
...
| livenessProbe.initialDelay | int | `15` | Anzahl Sekunden, bis die Probe für Liveness abgesetzt wird |
| livenessProbe.period | int | `10` | periodischer Abstand zwischen den Liveness-Proben in Sekunden |
| livenessProbe.timeout | int | `5` | Timeout für Liveness-Probe in Sekunden |
...
| progressDeadlineSeconds | int | `120` | max. Wartezeit in Sekunden, bis "failed progressing" eintritt |
| readinessProbe.failureThreshold | int | `3` | Max. Anzahl an Fehlversuchen bei den Readiness-Proben |
| readinessProbe.initialDelay | int | `15` | Anzahl Sekunden, bis die Probe für Readiness abgesetzt wird |
| readinessProbe.period | int | `10` | periodischer Abstand zwischen den Readiness-Proben in Sekunden |
| readinessProbe.timeout | int | `5` | Timeout für Readiness-Probe in Sekunden |
...
| servicePort | int | `8443` | Port des Kubernetes-Service |
